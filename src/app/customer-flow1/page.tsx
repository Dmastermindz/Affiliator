...
export default function CustomerFlow1() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      <header className="border-b border-white bg-gradient-to-r from-[#021019] to-[#0a192f] text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between p-4 sm:px-6 lg:px-8">
          ...
          <Button
            className="border-none bg-gradient-to-r from-[#2c7a7b] to-[#285e61] text-white hover:from-[#3b8a8c] hover:to-[#2d6e71]"
            onClick={() => logout()}
          >
            Sign Out
          </Button>
          ...
          <Card className="border border-gray-200 shadow-sm transition-shadow hover:shadow-md">
            ...
            <CardFooter>
              <Button
                onClick={() =>
                  window.open(
                    `https://buy.onramper.com/?apiKey=pk_prod_01GZXWJF7DNX8FSP2HK7W0KT53&onlyCryptos=usdc_arbitrum&mode=buy&onlyOnramps=guardarian&networkWallets=arbitrum:${connectedWallet || ""}&defaultFiat=usd&defaultAmount=55&defaultPaymentMethod=debitcard#`,
                    "_blank",
                    "noopener,noreferrer",
                  )
                }
                className="w-full border-none bg-gradient-to-r from-[#2c7a7b] to-[#285e61] text-white hover:from-[#3b8a8c] hover:to-[#2d6e71]"
              >
